          ...
          <Route
            ...
            element={
              <main className="relative z-20 mt-8">
                {/* Hero Section */}
                <section className="relative min-h-screen flex flex-col md:flex-row justify-center items-center text-white px-3 md:px-20">
                  {/* Text Left */}
                  ...
                  <div className="absolute bottom-25 flex justify-center w-full z-20">
